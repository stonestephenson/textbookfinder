  ...
  properties: {
    ...
    items: {
      ...
      items: {
        type: 'object',
        additionalProperties: false,
        required: ['courseCode', 'title', 'format', 'isbn', 'author', 'edition', 'listedPrice', 'confidence'],
        properties: {
          ...
          author: {
            ...
            description: 'author name(s) exactly as printed, e.g. from a "by …" line, or null',
          },
          edition: {
            anyOf: [{ type: 'string' }, { type: 'null' }],
            description: 'edition marker exactly as printed, e.g. "3RD 13", or null',
          },
          listedPrice: {
