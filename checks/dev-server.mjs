...
// Minimal shim for the two Vercel response conveniences api/parse.js uses
// (res.status().json() / .end()) plus Vercel's automatic JSON body parsing.
async function vercelStyle(req, res) {
  const chunks = [];
...
export function startDevServer() {
  return startServer(ROOT, { '/api/parse': vercelStyle });
}
